...
class FirstInningsCurtailedErrorTests(APITestCase):
    ...
    def test_missing_required_fields(self):
        ...
        # Deep copy inputs to avoid modifying base_payload for other tests if we were reusing it in a loop
    ...
    def test_validation_team2_overs_vs_team1_start_overs(self):
        ...
        payload = self.base_payload.copy()
        payload['inputs'] = self.base_payload['inputs'].copy()
        # Set T2 overs equal to T1 start overs (20.0) -> Invalid
    ...
    def test_validation_team1_used_overs_vs_team1_start_overs(self):
        ...
        payload = self.base_payload.copy()
        payload['inputs'] = self.base_payload['inputs'].copy()
        # Set used overs equal to start overs -> Invalid
    ...
    def test_validation_team2_overs_vs_team1_used_overs(self):
        ...
        NOTE: Validator currently checks:
        ...
        So valid is: Used >= T2 Available.
        Invalid is: Used < T2 Available.
        """
        payload = self.base_payload.copy()
        payload['inputs'] = self.base_payload['inputs'].copy()
        
        # Used = 15.0. Make T2 available = 16.0 -> Invalid
