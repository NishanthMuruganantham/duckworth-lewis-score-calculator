...
class FirstInningsInterruptedErrorTests(APITestCase):
    ...
    def setUp(self):
        ...
        self.base_payload = {
            ...
            "inputs": {
                ...
                "overs_available_to_team_1_after_resumption": 45.0,
    ...
    def test_missing_required_fields(self):
        ...
        del payload['inputs']['overs_available_to_team_1_after_resumption']

        response = self.client.post(self.url, payload, format='json')

        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST)
        self.assertIn('inputs', response.data)
        self.assertIn('overs_available_to_team_1_after_resumption', response.data['inputs'])
    ...
    def test_start_overs_vs_resumption_overs(self):
        ...
        payload = self.base_payload.copy()
        payload['inputs'] = self.base_payload['inputs'].copy()
        payload['inputs']['overs_available_to_team_1_after_resumption'] = 50.0
        ...
        self.assertIn(
            ...
            response.data['inputs']['overs_available_to_team_1_after_resumption']
        )
    ...
    def test_resumption_overs_vs_team2_start(self):
        ...
        self.assertIn(
            'Must be lesser than oversAvailableToTeam1AfterResumption', 
